...
```
page      : lire-un-graphe
fichier   : chapitres/06-lire-un-graphe.html
surtitre  : Chapitre 6
```
...
Donc pour un post-mortem, lire d'abord le compteur brut, et n'utiliser une fenêtre
qu'une fois qu'on sait où l'incident se situe sur la ligne du temps. Et quand la durée
...
moment où l'événement a eu lieu. Un conteneur a été tué à un instant connu,
<mesure valeur="11:21:31" source="labo, 2026-08-26">d'après l'horodatage de sa fin, et le panneau l'a affiché à 11:23</mesure>,
parce que la collecte suivante a eu lieu à ce moment-là. Deux minutes d'erreur suffisent
