...
1. mars à août 2026 CARIAD, groupe Volkswagen lead dev, via Lunatech Chez la filiale logicielle du groupe Volkswagen, migration d'un outil de gestion des accès, d'un monolithe rendu côté serveur vers React et une API REST. Le motif Strangler Fig, endpoint par endpoint derrière un feature flag, avec retour arrière instantané et sans régression. Java · Spring Boot · React 19 · TypeScript · Vitest
