...
(voir la [cardinalité](#/fr/blog/introduction-observabilite/trois-piliers#la-cardinalite)).
...
La seconde est le collecteur, dont le [chapitre précédent](#/fr/blog/introduction-observabilite/le-trajet#ce-que-le-tuyau-achete)
...
l'[enquête en trois clics](#/fr/blog/introduction-observabilite/trois-piliers#le-checkout-lent).
