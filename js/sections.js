...
const OBS2 = 'blog/observabilite-aller-plus-loin'
...
export const ARTICLES = [
  {
    ...
    fr: {
      ...
      pages: [
        ...
        { slug: 'trois-piliers',        titre: 'Trois signaux, trois niveaux de détail', minutes: 5, fichier: `${OBS}/fr/02-trois-piliers.html` },
        ...
        { slug: 'lire-un-graphe',       titre: 'Lire un graphe sans se tromper', minutes: 2, fichier: `${OBS}/fr/06-lire-un-graphe.html` },
        { slug: 'alerting',             titre: "Une alerte doit atteindre quelqu'un", minutes: 2, fichier: `${OBS}/fr/07-alerting.html` },
        { slug: 'dashboard-vert',       titre: "Ce qu'un dashboard vert ne dit pas", minutes: 2, fichier: `${OBS}/fr/08-dashboard-vert.html` },
        { slug: 'checklist',            titre: 'Checklist pratique', minutes: 2, fichier: `${OBS}/fr/09-checklist.html` }
      ]
    },
    en: {
      ...
      pages: [
        ...
        { slug: 'trois-piliers',        titre: 'Three signals, three levels of detail', minutes: 4, fichier: `${OBS}/en/02-trois-piliers.html` },
        ...
        { slug: 'lire-un-graphe',       titre: 'Reading a graph without being fooled', minutes: 2, fichier: `${OBS}/en/06-lire-un-graphe.html` },
        { slug: 'alerting',             titre: 'An alert has to reach someone', minutes: 2, fichier: `${OBS}/en/07-alerting.html` },
        { slug: 'dashboard-vert',       titre: 'What a green dashboard does not say', minutes: 2, fichier: `${OBS}/en/08-dashboard-vert.html` },
        { slug: 'checklist',            titre: 'A practical checklist', minutes: 2, fichier: `${OBS}/en/09-checklist.html` }
      ]
    }
  },
  {
    slug: 'observabilite-aller-plus-loin',
    publie: '2026-09-09',
    maj: '2026-09-09',
    ecriture: 'ia',
    fr: {
      titre: "L'observabilité, pour aller plus loin",
      pages: [
        { slug: 'accueil',        titre: "L'observabilité, pour aller plus loin", minutes: 1, fichier: `${OBS2}/fr/00-accueil.html` },
        { slug: 'lire-une-serie', titre: 'Lire une série temporelle', minutes: 3, fichier: `${OBS2}/fr/01-lire-une-serie.html` },
        { slug: 'sondes',         titre: 'Les sondes sont des commandes', minutes: 4, fichier: `${OBS2}/fr/02-sondes.html` },
        { slug: 'livrer',         titre: "L'observabilité dans le pipeline", minutes: 2, fichier: `${OBS2}/fr/03-livrer.html` }
      ]
    },
    en: {
      titre: 'Observability, going further',
      pages: [
        { slug: 'accueil',        titre: 'Observability, going further', minutes: 1, fichier: `${OBS2}/en/00-accueil.html` },
        { slug: 'lire-une-serie', titre: 'Reading a time series', minutes: 3, fichier: `${OBS2}/en/01-lire-une-serie.html` },
        { slug: 'sondes',         titre: 'Probes are commands', minutes: 4, fichier: `${OBS2}/en/02-sondes.html` },
        { slug: 'livrer',         titre: 'Observability in the pipeline', minutes: 2, fichier: `${OBS2}/en/03-livrer.html` }
      ]
    }
  }
]
